...
class User extends \source\core\base\BaseActiveRecord  implements \yii\web\IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => LsYii::gT('ID'),
            'username' => LsYii::gT('Username'),
            'password'=> LsYii::gT('Password'),
            'auth_key' => LsYii::gT('Auth Key'),
            'password_hash' => LsYii::gT('Password Hash'),
            'password_reset_token' => LsYii::gT('Password Reset Token'),
            'email' => 'Email',
            'status' => '状态',
            'statusText' => '状态',
            'created_at' => '创建时间',
