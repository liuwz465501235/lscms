...
namespace backend\gii\generators\lscmsmodel;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function getModuleDir()
    {
        ...
        $className = \backend\gii\generators\lscmsmodule\Generator::className();
    ...
    {
        return array_merge(parent::stickyAttributes(), ['db', 'baseClass', 'generateRelations', 'generateLabelsFromComments', 'queryNs', 'queryBaseClass']);
    }
