...
return [
    ...
    'Return'=>'返回',
    'save success'=>'保存成功',
    'Register And Visit'=>'注册与访问',
    'Basic Setting'=>'基础设置',
    'SEO Setting'=>'SEO设置',
    'Theme Setting'=>'主题设置',
    'Modularity Setting'=>'模块设置',
    'Datetime Setting'=>'时间设置',
    '<span class="glyphicon glyphicon-plus"></span> Create {attribute}'=>'<span class="glyphicon glyphicon-plus"></span> 新建{attribute}',
    'Modularity'=>'模块',
    '{attribute} Success' =>'{attribute}成功',
    '{attribute} Error' =>'{attribute}失败',
    'Active Admin'=>'启用后台',
    'Active Home'=>'启用前台',
    'Deactive Admin'=>'关闭后台',
    'Deactive Home'=>'关闭前台',
    'Uninstall Modularity'=>'卸载',
    'Install Modularity'=>'安装模块',
];
