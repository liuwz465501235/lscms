...
<div class="mainbody">
    <div class="agreement_area">
        <div class="agreement">
            ...
            <p>LsYii CMS官方网站为 <?=Html::a(LsYii::getHostInfo(), LsYii::getHostInfo(), array('target'=>'_blank' , 'class'=>'action'));?></p>
            <p>
...
具有操作简单、稳定、安全、高效、跨平台等特点。采用MVC设计模式，模板定制方便灵活，内置小挂工具，方便制作各类功能和效果.
            ...
            <p>
                我们将使用这些信息创建<code>common\config\db.php</code>文件。	如果出于任何原因，文件自动创建失败，请不要担心。这个向导的目的只是代您编辑配置文件，填入数据库信息。
                您可以直接使用文本编辑器打开<code>common\config\db.php</code>，填入您的信息，再另存为<code>common\config\db.php</code>。 需要帮助？没问题！
