...
<div class="mainbody">
        ...
        <tr>
            ...
            <td><?php
                if(function_exists('disk_free_space')) {
                        @$env_items[$key]['current'] = Common::HumanSize(disk_free_space('../'));
                }
                else{
    ...
    <div class="inst_btn_area">
        ...
        <p class="env_success">恭喜！您的服务器配置完全符合LsYii CMS的安装要求。 </p>
        <?php elseif(($requireResult < 0 || $writeableResult <0) ): ?>
        <p class="tips">您的服务器配置符合LsYii CMS的最低要求。如果您需要使用特定的功能，请关注以上警告部分。 </p>
        <?php else: ?>
        <p class="tips error">您的服务器配置未能满足LsYii CMS的安装要求。 </p>
        <?php endif; ?>
